        ...
        <div class="col-md-12 col-sm-12">
          ...
          <div class="panel-group checkout-page accordion scrollable" id="checkout-page">
            ...
            <div id="checkout" class="panel panel-default">
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#checkout-content" class="accordion-toggle collapsed" aria-expanded="false">
            ...
            <div id="payment-address" class="panel panel-default">
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#payment-address-content" class="accordion-toggle collapsed" aria-expanded="false">
                    Step 2: Account &amp; Billing Details
                  </a>
                </h2>
              </div>
              <div id="payment-address-content" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                <div class="panel-body row">
                  <div class="col-md-6 col-sm-6">
            ...
            <div id="shipping-method" class="panel panel-default">
              ...
              <div id="shipping-method-content" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                <div class="panel-body row">
                  <div class="col-md-12">
